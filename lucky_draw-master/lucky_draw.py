...
class LuckyDraw:
    def __init__(self,data):
        ...
        self.image = Image.open("static/background.jpg")
        ...
        self.label_reset.place(x=300, y=500, width=100, height=54)
        ...
        self.label_start.place(x=600, y=370, width=200, height=50)
        ...
        self.third.place(x=926, y=465, width=120, height=54)
        ...
        self.second.place(x=926, y=300, width=120, height=54)
        ...
        self.first.place(x=926, y=135, width=120, height=54)
    ...
    def setwindow(self):
        ...
        self.btn1 = tkinter.Button(self.root, text='', bg='#d83131',font=displayfont)
        # self.btn1.config(font=("Courier", 30))
        self.btn1.place(x=640, y=500, width=100, height=70)

        self.source = tkinter.Text(self.root,bg="#d83131",fg="lightyellow")
        self.source.place(x=100, y=250, width=300, height=90)
        ...
        self.target_3 = tkinter.Listbox(self.root,height=5,font=myFont,bg="#d83131",bd=1,fg="lightyellow")
        self.target_3.place(x=1095, y=465, width=110, height=108)

        self.target_2 = tkinter.Listbox(self.root,height=5,font=myFont,bg="#d83131",bd=1,fg="lightyellow")
        self.target_2.place(x=1095, y=300,  width=110, height=72)

        self.target_1 = tkinter.Listbox(self.root,height=5,font=myFont,bg="#d83131",bd=1,fg="lightyellow")
        self.target_1.place(x=1095, y=135, width=110, height=36)
            ...
            if self.newloop == True:
                ...
                if self.target.size()>=1:
                    if self.target==self.target_3:
                        ...
                        self.btn1['text'] = "Bye～"
                        tkinter.messagebox.showinfo('提示', "本轮一等奖抽奖结束!")
                        return
                if self.target.size()>=3:
                    if self.target==self.target_2:
                        self.target=self.target_2
                    else:
                        self.btn1['text'] = "Bye～"
                        tkinter.messagebox.showinfo('提示', "本轮三等奖抽奖结束!")
                        return
                if self.target.size()>=2:
                    if self.target==self.target_1:
                        self.target=self.target_1
                    else:
                        self.btn1['text'] = "Bye～"
                        tkinter.messagebox.showinfo('提示', "本轮2抽奖结束!")
                        return
                self.target.insert(tkinter.END, r.center(3," "))
    ...
    def set_third(self,event):
        if self.target_3.size()>=3:
            if self.target_3.size()>=3:
                tkinter.messagebox.showinfo('提示',"三等奖（3位）已产生！")
            else:
                self.target = self.target_3
        else:
            self.target = self.target_3
    ...
    def set_second(self,event):
        if self.target_2.size()>=2:
            tkinter.messagebox.showinfo('提示',"二等奖（2位）已产生！")
        else:
            self.target = self.target_2

    def set_first(self,event):
        if self.target_1.size()>=1:
            tkinter.messagebox.showinfo('提示',"一等奖（1位）已产生！")
        else:
            self.target = self.target_1
